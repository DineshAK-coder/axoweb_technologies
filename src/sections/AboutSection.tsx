    ...
    <section id="about" className="relative min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 py-20 bg-[#0C0C0C] overflow-hidden">
      ...
      {decoImages.map((img, i) => (
        <FadeIn 
          ...
          duration={0.9}
        >
          <img src={img.src} alt="Decoration" className="w-full h-auto" />
        </FadeIn>
      ))}

      {/* Main Content */}
      <div className="flex flex-col items-center gap-10 sm:gap-14 md:gap-16 max-w-4xl text-center relative z-10">
        <FadeIn delay={0} y={40}>
        ...
        <div className="flex flex-col items-center gap-16 sm:gap-20 md:gap-24">
          <AnimatedText 
            text="With more than five years of experience in design and development, we focus on branding, web design, and AI automation solutions. We truly enjoy working with businesses that aim to stand out and present their best image. Let's build something incredible together!"
